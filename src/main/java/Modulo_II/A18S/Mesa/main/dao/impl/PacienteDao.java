...
import Modulo_II.A18S.Mesa.main.model.Endereco;
import Modulo_II.A18S.Mesa.main.model.Paciente;
...
public class PacienteDao implements IDao<Paciente> {
    ...
    public Paciente salvar(Paciente paciente) {
        ...
        try {
            ...
            preparedStatement.setDate(4, new Date(paciente.getDataNascimento().getTime()));
